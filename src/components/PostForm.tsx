...
import { useUserInitial } from "../hooks";
...
export default function PostForm() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!trimmedContent || !imageFile) {
      toast.error("Please add both content and image to create a post.");
      return;
    }
  ...
  const composerActions = [
    {
      key: "photo",
      label: "Photo",
      wrapperClass: "_feed_inner_text_area_bottom_photo _feed_common",
      icon: (
        <svg
    ...
    },
    {
      key: "video",
      label: "Video",
      wrapperClass: "_feed_inner_text_area_bottom_video _feed_common",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="22"
    ...
    },
    {
      key: "event",
      label: "Event",
      wrapperClass: "_feed_inner_text_area_bottom_event _feed_common",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="22"
    ...
    },
    {
      key: "article",
      label: "Article",
      wrapperClass: "_feed_inner_text_area_bottom_article _feed_common",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="18"
  ...
  const renderComposerActions = (showLabel: boolean) => (
    <div className="_feed_inner_text_area_item">
      {composerActions.map((action) => (
        <div key={action.key} className={action.wrapperClass}>
          <button
            type="button"
            className="_feed_inner_text_area_bottom_photo_link"
            onClick={action.key === "photo" ? handlePhotoClick : undefined}
          >
