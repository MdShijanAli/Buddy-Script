...
export default function TimeLinePosts() {
  ...
  const getDisplayName = (name?: string, fallback = "Anonymous") =>
    (name && name.trim()) || fallback;

  const getAvatar = (avatar?: string | null) =>
    avatar && avatar.trim() ? avatar : commentAuthorFallbackImage;
            ...
            <div className="_feed_inner_timeline_reaction">
              ...
              <button
                ...
                className={`_feed_inner_timeline_reaction_comment _feed_reaction ${
                  expandedCommentsByPost[post.id] ? "_feed_reaction_active" : ""
                }`}
                ...
                <div className="_timline_comment_main">
                  ...
                  {!commentsLoadingByPost[post.id] &&
                    (commentsByPost[post.id]?.length ?? 0) > 0 && (
                      <div className="_previous_comment">
                        <button type="button" className="_previous_comment_txt">
                          View {commentsByPost[post.id].length} previous
                          comments
                        </button>
                      </div>
                    )}
