...
import txtImage from "../assets/images/txt_img.png";
import postImage from "../assets/images/post_img.png";
        ...
        <div className="_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
          <div className="_feed_inner_text_area_box">
            <div className="_feed_inner_text_area_box_image">
              <img src={txtImage} alt="Image" className="_txt_img" />
            </div>
        ...
        <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
          <div className="_feed_inner_timeline_content _padd_r24 _padd_l24">
            <div className="_feed_inner_timeline_post_top">
              <div className="_feed_inner_timeline_post_box">
                <div className="_feed_inner_timeline_post_box_image">
                  <img src={postImage} alt="" className="_post_img" />
                </div>
            ...
            <div className="_feed_inner_timeline_image">
              <img src={timeLineImage} alt="" className="_time_img" />
            </div>
          </div>
          ...
          <div className="_feed_inner_timeline_reaction">
            <button
              className={`_feed_inner_timeline_reaction_emoji _feed_reaction ${likes["post1"] ? "_feed_reaction_active" : ""}`}
